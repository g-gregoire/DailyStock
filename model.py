...
stock.logData("YRI.TO") #default is one day

#%% Pull Data from DB

data = stock.viewData("YRI.TO", startDate = "2020-07-01", endDate = "2020-07-28") #default is last day
print(data.size/5)
